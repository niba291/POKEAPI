...
export function Card({item, onClick}) {
    // VARIABLES===========================================================================================================    
    return (
        <div className="flex flex-wrap justify-center rounded-md w-[12rem] font-bold shadow-md border font-sans md:m-14 mx-2 my-14 hover:scale-110 transition duration-300 cursor-pointer object-cover" onClick={onClick}>
            ...
            <label className="w-full text-center pt-5 pb-3 text-ms text-gray-500 cursor-pointer capitalize">{item.name}</label>
    ...
    return (      
        <>
            {loading ? 
                ...
                :
                    <div className="flex flex-wrap justify-center items-start rounded-md w-full font-bold shadow-md border font-sans h-[78vh]">
                        ...
                        <div className="w-full h-[65%]">
                            <h1 className="text-center font-bold text-xl text-gray-400">#{item.id.toString().padStart(3, "0")}</h1>
                            <h1 className="text-center py-3 text-ms capitalize text-2xl text-gray-500">{item.name}</h1>
                            ...
                            <div className="w-full flex flex-wrap justify-center">
                                <label className="w-1/6 text-center text-gray-500 text-ms">{item.weight} Kg</label>
                                <label className="w-1/6 text-center text-gray-500 text-ms">{item.height} m</label>
                            </div>
                            <p className="text-gray-500 px-20 py-8">
                                {description}
                            </p>
                            <div className="w-full flex flex-wrap justify-center py-2 text-gray-500 uppercase font-medium">
